...
$46772b835b3d1aed$exports = JSON.parse('{"name":"@parcel/fs","version":"2.9.0","description":"Blazing fast, zero configuration web application bundler","license":"MIT","publishConfig":{"access":"public"},"funding":{"type":"opencollective","url":"https://opencollective.com/parcel"},"repository":{"type":"git","url":"https://github.com/parcel-bundler/parcel.git"},"main":"lib/index.js","source":"src/index.js","types":"index.d.ts","engines":{"node":">= 12.0.0"},"targets":{"types":false,"main":{"includeNodeModules":{"@parcel/core":false,"@parcel/fs-search":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}},"browser":{"includeNodeModules":{"@parcel/core":false,"@parcel/fs-search":false,"@parcel/types":false,"@parcel/utils":false,"@parcel/watcher":false,"@parcel/workers":false}}},"scripts":{"build-ts":"mkdir -p lib && flow-to-ts src/types.js > lib/types.d.ts","check-ts":"tsc --noEmit index.d.ts"},"dependencies":{"@parcel/fs-search":"2.9.0","@parcel/types":"2.9.0","@parcel/utils":"2.9.0","@parcel/watcher":"^2.0.7","@parcel/workers":"2.9.0"},"devDependencies":{"graceful-fs":"^4.2.4","ncp":"^2.0.0","nullthrows":"^1.1.1","utility-types":"^3.10.0"},"peerDependencies":{"@parcel/core":"^2.9.0"},"browser":{"@parcel/fs":"./lib/browser.js","./src/NodeFS.js":"./src/NodeFS.browser.js"},"gitHead":"dd9435be8afed35c5ffc161cf4b586fd6c78fc1f"}');
...
function $792f6c711e82470e$export$d51a93c758976388(fs, fileNames, dir, root) {
    let { root: pathRoot  } = (0, ($parcel$interopDefault($ki5hV$path))).parse(dir);
...
try {
    ({ threadId: $10145ab9dc478fed$var$threadId  } = $10145ab9dc478fed$import$9c2ae04019a9b9e3);
} catch  {
//
}
...
class $86a3ba4eb3a17970$export$3048eb7ec07c2c4e {
    ...
    _normalizePath(filePath, realpath = true) {
        filePath = (0, ($parcel$interopDefault($ki5hV$path))).resolve(this.cwd(), filePath);
...
const $e46c9778a96a2930$var$pipeline = (0, $ki5hV$util.promisify)((0, ($parcel$interopDefault($ki5hV$stream))).pipeline);
